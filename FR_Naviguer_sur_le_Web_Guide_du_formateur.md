...
<!-- [comment] : (This table is not being used because Markdown do not handle merging cells properly.)-->

<!--
|Adresse URL typosquattée | Type d’erreur |       |
| :------------ | :-----------: | -------------------: |
|xample.com,example.com,xemple.com|Faute de frappe
| example.org, example.biz, example.info, example.ca| Domaine différent (suffixe)| MISE	EN	GARDE :	Ne visitez	aucun	de ces sites. Certains contiennent des programmes	malveillants.               |
...
Soyez	à	l’affût	des	différentes	menaces	possibles	pour	pouvoir	cerner	les	dangers	auxquels
